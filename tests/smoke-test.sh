...
assert_contains "$(cat "${REPO_ROOT}/install.sh")" 'INSTALLER_VERSION="2026-07-19-15"' "installer version 2026-07-19-15"
...
assert_contains "$OUT" "Installer version: 2026-07-19-15" "non-interactive version"
